...
let textInfo;
let myText = document.querySelector("#textInfo")
...
if( (examGrade => 0) && (examGrade <= 100)){
    ...
    if(examGrade >= 90){
        ...
        textInfo = `${SAD} FF`
        myText.classList.remove("text-primary")
        myText.classList.add("text-danger")     
    }
    
}
else{
    textInfo = "Lütfen geçerli bir not giriniz"
    examGrade += " (Notlandırma yapılamamıştır)"
}

myText.innerHTML = `${textInfo} --> ${examGrade}`
